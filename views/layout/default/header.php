        ...
        <nav class="px-nav px-nav-left">
          ...
          <ul class="px-nav-content">
            <li class="px-nav-box p-a-3 b-b-1" id="demo-px-nav-box">
              ...
              <div class="btn-group hide" style="margin-top: 4px;">
            ...
            <?php if (isset($_SESSION['menu']['MENU_TIENDA_1'])):?>
              <li class="px-nav-item px-nav-dropdown">
              <a href=""><i class="px-nav-icon fa fa-shopping-cart"></i><span class="px-nav-label">Tienda</span></a>
                <ul class="px-nav-dropdown-menu">
            ...
            <?php if (isset($_SESSION['menu']['MENU_TIENDA_2'])):?>
              <li class="px-nav-item px-nav-dropdown">
              <a href=""><i class="px-nav-icon fa fa-shopping-cart"></i><span class="px-nav-label">Almacen</span></a>
                <ul class="px-nav-dropdown-menu">
                  <?php foreach ($_SESSION['menu']['MENU_TIENDA_2'] as $submenu):?>
                    <li class="px-nav-item"><a href="<?php  echo BASE_URL . $submenu['UBICACION'] . "?idLocal=". $submenu['NIDLOCAL'] ?>"><span class="px-nav-label"><?php echo $submenu['DESCRIPCION']?></span></a></li>
                  <?php endforeach;?>
                </ul>
              </li>
            ...
            <?php if (isset($_SESSION['menu']['MENU_TALLER']) && false):?>
              <li class="px-nav-item px-nav-dropdown">
              <a href=""><i class="px-nav-icon fa fa-shopping-cart"></i><span class="px-nav-label">Taller</span></a>
                <ul class="px-nav-dropdown-menu">
                  <?php foreach ($_SESSION['menu']['MENU_TALLER'] as $submenu):?>
                    <li class="px-nav-item"><a href="<?php  echo BASE_URL . $submenu['UBICACION'] . "?idLocal=". $submenu['NIDLOCAL'] ?>"><span class="px-nav-label"><?php echo $submenu['DESCRIPCION']?></span></a></li>
                  <?php endforeach;?>
                </ul>
              </li>
            ...
            <?php if (isset($_SESSION['menu']['MENU_TIENDA_3']) && false):?>
              ...
              <a href=""><i class="px-nav-icon fa fa-shopping-cart"></i><span class="px-nav-label">Local 2</span></a>
                <ul class="px-nav-dropdown-menu">
                  <?php foreach ($_SESSION['menu']['MENU_TIENDA_3'] as $submenu):?>
                    <li class="px-nav-item"><a href="<?php  echo BASE_URL . $submenu['UBICACION'] . "?idLocal=". $submenu['NIDLOCAL'] ?>"><span class="px-nav-label"><?php echo $submenu['DESCRIPCION']?></span></a></li>
                  <?php endforeach;?>
                </ul>
              </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="hide"><a href=""><span class="label label-warning pull-xs-right"><i class="fa fa-asterisk"></i></span>Perfil</a></li>
                  <li class="divider"></li>
