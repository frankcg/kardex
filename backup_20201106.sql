...
MySQL - 5.5.5-10.3.25-MariaDB-cll-lve : Database - fzbsokgg_tauro_kardex_v3
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fzbsokgg_tauro_kardex_v3` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `fzbsokgg_tauro_kardex_v3`;
...
CREATE TABLE `kar_compra_taller` (
  ...
  KEY `nIDCOMPRA` (`nIDCOMPRA`),
  CONSTRAINT `kar_compra_taller_ibfk_1` FOREIGN KEY (`nIDCOMPRA`) REFERENCES `kar_compra` (`nIDCOMPRA`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
insert  into `seguridad_modulo_perfil`(`IDDETALLE`,`IDMODULO`,`IDPERFIL`,`PERMISO`,`dFECHAMOD`) values (0191,01,07,0,'0000-00-00 00:00:00'),(0192,19,07,0,'0000-00-00 00:00:00'),(0193,20,07,0,'0000-00-00 00:00:00'),(0194,21,07,0,'0000-00-00 00:00:00'),(0195,11,05,0,'0000-00-00 00:00:00'),(0196,12,05,0,'0000-00-00 00:00:00'),(0197,15,05,0,'0000-00-00 00:00:00'),(0198,01,05,0,'0000-00-00 00:00:00'),(0199,01,08,0,'0000-00-00 00:00:00'),(0200,12,08,0,'0000-00-00 00:00:00'),(0201,15,08,0,'0000-00-00 00:00:00'),(0202,19,08,0,'0000-00-00 00:00:00'),(0203,21,08,0,'0000-00-00 00:00:00'),(0204,10,01,0,'0000-00-00 00:00:00'),(0205,11,01,0,'0000-00-00 00:00:00'),(0206,12,01,0,'0000-00-00 00:00:00'),(0207,13,01,0,'0000-00-00 00:00:00'),(0208,14,01,0,'0000-00-00 00:00:00'),(0209,15,01,0,'0000-00-00 00:00:00'),(0210,16,01,0,'0000-00-00 00:00:00'),(0211,17,01,0,'0000-00-00 00:00:00'),(0212,01,01,0,'0000-00-00 00:00:00'),(0213,02,01,0,'0000-00-00 00:00:00'),(0214,18,01,0,'0000-00-00 00:00:00'),(0215,19,01,0,'0000-00-00 00:00:00'),(0216,20,01,0,'0000-00-00 00:00:00'),(0217,21,01,0,'0000-00-00 00:00:00'),(0218,22,01,0,'0000-00-00 00:00:00'),(0219,23,01,0,'0000-00-00 00:00:00'),(0220,24,01,0,'0000-00-00 00:00:00'),(0221,25,01,0,'0000-00-00 00:00:00'),(0222,26,01,0,'0000-00-00 00:00:00'),(0223,27,01,0,'0000-00-00 00:00:00'),(0224,28,01,0,'0000-00-00 00:00:00'),(0225,29,01,0,'0000-00-00 00:00:00'),(0226,30,01,0,'0000-00-00 00:00:00');
...
insert  into `sel_cliente`(`nIDCLIENTE`,`sDESCRIPCION`,`nESTADO`,`sIDUSUARIOCREACION`,`dFECHACREACION`,`sIDUSUARIOMOD`,`dFECHAMOD`) values (0000001,'CLIENTE GENERAL',1,'','2020-11-06 10:06:46',NULL,'0000-00-00 00:00:00');
...
insert  into `sel_cuenta`(`nIDCUENTA`,`sDESCRIPCION`,`nESTADO`,`dFECHAMOD`) values (0001,'',1,'2020-11-01 23:14:43'),(0003,'111155554443333',1,'0000-00-00 00:00:00'),(0004,'1515-1515-1515-1515',1,'0000-00-00 00:00:00'),(0005,'1111444466669999',1,'0000-00-00 00:00:00'),(0006,'',1,'0000-00-00 00:00:00'),(0007,'',1,'0000-00-00 00:00:00'),(0008,'',1,'0000-00-00 00:00:00');
...
/*Table structure for table `vw_sel_productos_precioavg` */

DROP TABLE IF EXISTS `vw_sel_productos_precioavg`;

/*!50001 DROP VIEW IF EXISTS `vw_sel_productos_precioavg` */;
/*!50001 DROP TABLE IF EXISTS `vw_sel_productos_precioavg` */;

/*!50001 CREATE TABLE  `vw_sel_productos_precioavg`(
 `nIDPRODUCTO` int(5) unsigned zerofill ,
 `nIDLOCAL` int(4) unsigned zerofill ,
 `sNOMBRE` char(150) ,
 `avgPorCantidadPrecio` double(19,2) ,
 `avgPrecio` double(19,2) 
)*/;
...
/*!50001 CREATE SQL SECURITY DEFINER VIEW `vw_sel_productos_inversion` AS (select `az`.`nLOCAL` AS `nLOCAL`,`az`.`sLOCAL` AS `sLOCAL`,`az`.`nIDPRODUCTO` AS `nIDPRODUCTO`,`az`.`sNOMBRE` AS `sNOMBRE`,`az`.`nCANTIDAD` AS `nCANTIDAD`,`az`.`nTOTAL` AS `nTOTAL`,`az`.`avgPorCantidadPrecio` AS `avgPorCantidadPrecio`,`az`.`avgPrecio` AS `avgPrecio` from (select `a`.`nIDLOCAL` AS `nLOCAL`,`d`.`sDESCRIPCION` AS `sLOCAL`,`a`.`nIDPRODUCTO` AS `nIDPRODUCTO`,`a`.`sNOMBRE` AS `sNOMBRE`,(select sum(`b`.`nCANTIDAD`) AS `nCANTIDAD` from `fzbsokgg_tauro_kardex_v3`.`kar_compra_detalle` `b` where `a`.`nIDPRODUCTO` = `b`.`nIDPRODUCTO` and `b`.`nESTADO` = 1) - (select case when sum(`c`.`nCANTIDAD`) is not null then sum(`c`.`nCANTIDAD`) else 0 end AS `ventas` from `fzbsokgg_tauro_kardex_v3`.`kar_venta_detalle` `c` where `a`.`nIDPRODUCTO` = `c`.`nIDPRODUCTO` and `c`.`nESTADO` = 1) AS `nCANTIDAD`,(select sum(`z`.`nCANTIDAD` * `z`.`fPRECIO`) AS `total` from `fzbsokgg_tauro_kardex_v3`.`kar_compra_detalle` `z` where `z`.`nIDPRODUCTO` = `a`.`nIDPRODUCTO` and `z`.`bSTOCK` = '1' and `z`.`nESTADO` = '1') AS `nTOTAL`,(select round(sum(`y`.`nCANTIDAD` * `y`.`fPRECIO`) / sum(`y`.`nCANTIDAD`),2) from `fzbsokgg_tauro_kardex_v3`.`kar_compra_detalle` `y` where `y`.`nESTADO` = 1 and `y`.`nIDPRODUCTO` = `a`.`nIDPRODUCTO`) AS `avgPorCantidadPrecio`,(select round(avg(`x`.`fPRECIO`),2) from `fzbsokgg_tauro_kardex_v3`.`kar_compra_detalle` `x` where `x`.`nESTADO` = 1 and `x`.`nIDPRODUCTO` = `a`.`nIDPRODUCTO`) AS `avgPrecio` from (`fzbsokgg_tauro_kardex_v3`.`kar_producto` `a` join `fzbsokgg_tauro_kardex_v3`.`sel_local` `d` on(`a`.`nIDLOCAL` = `d`.`nIDLOCAL`)) where `a`.`nESTADO` = 1 group by `a`.`nIDPRODUCTO`) `az` where `az`.`nCANTIDAD` > 0 order by `az`.`sNOMBRE`) */;
...
/*!50001 CREATE SQL SECURITY DEFINER VIEW `vw_sel_productos_stock` AS (select `az`.`nLOCAL` AS `nLOCAL`,`az`.`sLOCAL` AS `sLOCAL`,`az`.`nIDPRODUCTO` AS `nIDPRODUCTO`,`az`.`sNOMBRE` AS `sNOMBRE`,`az`.`nCANTIDAD` AS `nCANTIDAD` from (select `a`.`nIDLOCAL` AS `nLOCAL`,`d`.`sDESCRIPCION` AS `sLOCAL`,`a`.`nIDPRODUCTO` AS `nIDPRODUCTO`,`a`.`sNOMBRE` AS `sNOMBRE`,(select sum(`b`.`nCANTIDAD`) AS `nCANTIDAD` from `fzbsokgg_tauro_kardex_v3`.`kar_compra_detalle` `b` where `a`.`nIDPRODUCTO` = `b`.`nIDPRODUCTO` and `b`.`nESTADO` = 1) - (select case when sum(`c`.`nCANTIDAD`) is not null then sum(`c`.`nCANTIDAD`) else 0 end AS `ventas` from `fzbsokgg_tauro_kardex_v3`.`kar_venta_detalle` `c` where `a`.`nIDPRODUCTO` = `c`.`nIDPRODUCTO` and `c`.`nESTADO` = 1) AS `nCANTIDAD` from (`fzbsokgg_tauro_kardex_v3`.`kar_producto` `a` join `fzbsokgg_tauro_kardex_v3`.`sel_local` `d` on(`a`.`nIDLOCAL` = `d`.`nIDLOCAL`)) where `a`.`nESTADO` = 1 group by `a`.`nIDPRODUCTO`) `az` where `az`.`nCANTIDAD` > 0 order by `az`.`sNOMBRE`) */;

/*View structure for view vw_sel_productos_precioavg */

/*!50001 DROP TABLE IF EXISTS `vw_sel_productos_precioavg` */;
/*!50001 DROP VIEW IF EXISTS `vw_sel_productos_precioavg` */;

/*!50001 CREATE SQL SECURITY DEFINER VIEW `vw_sel_productos_precioavg` AS (select `a`.`nIDPRODUCTO` AS `nIDPRODUCTO`,`b`.`nIDLOCAL` AS `nIDLOCAL`,`b`.`sNOMBRE` AS `sNOMBRE`,round(sum(`a`.`nCANTIDAD` * `a`.`fPRECIO`) / sum(`a`.`nCANTIDAD`),2) AS `avgPorCantidadPrecio`,truncate(avg(`a`.`fPRECIO`),2) AS `avgPrecio` from (`kar_compra_detalle` `a` join `kar_producto` `b` on(`a`.`nIDPRODUCTO` = `b`.`nIDPRODUCTO`)) where `a`.`nESTADO` = 1 group by `a`.`nIDPRODUCTO`) */;
